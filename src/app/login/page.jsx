...
function Login() {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      {/* Main content area */}
      <div className="w-full md:w-3/5 lg:w-2/3 p-4 sm:p-8 md:p-12 flex flex-col" style={{backgroundColor:"var(--background)"}}>
        ...
        <div className="flex-grow flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <a href="#" className="text-blue-500 hover:text-blue-300 text-sm font-medium transition-colors">
                Forgot Password?
              </a>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-[#B0B0B0]">
              New to Neon?{' '}
              <a href="#" className="text-blue-500 hover:text-blue-300 font-medium transition-colors">
