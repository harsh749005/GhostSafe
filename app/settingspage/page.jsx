    ...
    <>
      ...
      >
        ...
        <div className=" border border-[#2e2e2e] rounded-lg p-6 m-[auto] w-[650px]">
          <h2 className="text-xl font-medium mb-6 text-[#dedede]">Personal information</h2>
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-sm mb-2 text-[#949494] font-medium">First name</label>
              <input
                type="text"
                value={firstName}
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm text-[#949494] font-medium">Email</label>
              <button className="text-blue-400 hover:text-blue-300 text-sm font-medium">
                Change email
              </button>
            </div>
            <div className="w-full  border-2 border-[#2e2e2e] rounded px-3 py-2 text-white focus:outline-none focus:border-zinc-500"
>
              {email}
            </div>
          </div>
        ...
        <div className=" border border-[#2e2e2e] rounded-lg p-6 m-[auto] w-[650px]">
          <h2 className="text-xl font-medium mb-6 text-[#dedede]">Sign-in methods</h2>
        ...
        <div className="border border-[#2e2e2e] rounded-lg p-6 m-[auto] w-[650px]">
          <h2 className="text-xl font-medium mb-6 text-[#dedede]">Set password</h2>
          
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-[#949494]  mb-2 font-medium">Password</label>
            ...
            <div>
              <label className="block text-sm text-[#949494]  mb-2 font-medium">Confirm password</label>
              <div className="relative">
                <input
